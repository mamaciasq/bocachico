...
Leverage.normal(fit,0,"") 
qqplot.normal(fit,500,0.01,0,"")
Influence.normal(fit,3,2,0,"")

fit1<-lm(lpeso~lalt+llong, subset=-c(132))
summary(fit1)

fit2<-lm(lpeso~lalt+llong, subset=-c(132,61))
summary(fit2)

####Se evidencia que beta asociado a la long cambia notoriamente por la influencia de los puntos 132 y 61
